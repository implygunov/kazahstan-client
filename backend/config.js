...
module.exports = {
  ...
  MYSQL_HOST: process.env.MYSQL_HOST || 'a1282793.xsph.ru',
  MYSQL_PORT: Number(process.env.MYSQL_PORT || 3306),
  MYSQL_USER: process.env.MYSQL_USER || 'a1282793_sdadsfddsdwasdadasd',
  MYSQL_PASSWORD: process.env.MYSQL_PASSWORD || 'a12823EWHAUI376223523@1323QW223',
  MYSQL_DATABASE: process.env.MYSQL_DATABASE || 'a1282793_sdadsfddsdwasdadasd',
